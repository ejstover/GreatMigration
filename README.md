...
* Site picker intersection uses Mist `SDWAN_site_id` (from site/setting/derived variables) matched against vManage device site IDs; matching is numeric and tolerates integer-like strings such as `123` or `123.0`.
