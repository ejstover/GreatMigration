# Vendored from Python 3.11's telnetlib module to preserve compatibility on Python 3.13+ where it was removed.
# Original module copyright (C) Python Software Foundation.
