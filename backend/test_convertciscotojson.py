...
def test_cisco_to_juniper_if_direct_maps_24_port_sfp_range_to_uplink_ge_for_gi():
    out = cisco_to_juniper_if_direct(
...
def test_cisco_to_juniper_if_direct_maps_48_port_sfp_range_to_uplink_ge_for_gi():
    out = cisco_to_juniper_if_direct(
...
def test_cisco_to_juniper_if_direct_maps_uplink_module_gi_to_ge():
    out = cisco_to_juniper_if_direct(
...
def test_cisco_to_juniper_if_direct_maps_uplink_module_te_to_xe():
    out = cisco_to_juniper_if_direct(
