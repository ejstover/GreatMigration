...
def test_determine_switch_type_returns_access_when_stack_pid_not_in_env(monkeypatch):
...
def test_determine_switch_type_ignores_non_stack_pid_blocks(monkeypatch):
    monkeypatch.setenv("CORE_SWITCH_MODELS", "C9300-48UXM")
    running_config = "hostname NASPRMDFCS1"
    inventory = (
